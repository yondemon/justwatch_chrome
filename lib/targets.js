var supportedWeb = {
  'imdb' : {
    // HAS LDJSON
    block: function(){
      let block = document.querySelectorAll('[class^=WatchBox__WatchParent]')
      if (block.length == 0) {
  ...
  'rottentomatoes': {
    // HAS LDJSON
    block: function(){ return document.getElementById('where-to-watch'); },
  ...
  'sensacine.com/peliculas': {
    type: "movie",
    block: function(){ return document.getElementsByClassName('bam-container')[0]; },
  ...
  'filmaffinity.com': {
    block: function(){ return document.getElementsByClassName('film-right-box')[0]; },
    title: function(){ return document.querySelectorAll('meta[property="og:title"]')[0].getAttribute('content'); },
    year: function(){ return null; },
  },
  'trakt.tv/movies': {
    block: function(){ return document.getElementsByClassName('streaming-links')[0]; },
    title: function(){ return document.querySelectorAll('meta[property="og:title"]')[0].getAttribute('content'); },
    year: function(){ console.log(document.querySelectorAll('h1 .year')); return document.querySelectorAll('h1 .year')[0].innerText; },
    type: "movie",
  },
  'trakt.tv/shows': {
    block: function(){ return document.getElementsByClassName('streaming-links')[0]; },
  ...
  'ecartelera.com': {
    ...
    year: function(){ return document.querySelectorAll('.datospelicula .year')[0].innerText; },
  },
  ...
  'allmovie.com': {
    block: function(){ return document.getElementsByClassName('streams')[0]; },
    title: function(){ return document.querySelectorAll('meta[property="og:title"]')[0].getAttribute('content'); },
